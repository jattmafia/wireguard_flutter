...
class WireguardPlugin {
  static const MethodChannel _channel = const MethodChannel('tark.pro/wireguard-flutter');

  /// no need to close, since it's static controller
  // ignore: close_sinks
  static final _tunnelsStateController = StreamController<StateChangeData>.broadcast();

  static Stream<StateChangeData> get tunnelState => _tunnelsStateController.stream;
